...
// I added a random number generator that also flipped the sign (RandomSignedFloat).
...
public class ExtRandom<T>
{
    public static void RandomizeSeed()
    {
   	...
   	public static Vector3 RandomSpread(Vector3 direction, float spreadX, float spreadY, float spreadZ)
   	{
		return new Vector3 (direction.x + Random.Range (-spreadX, spreadX),
